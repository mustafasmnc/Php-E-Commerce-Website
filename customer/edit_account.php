...
<form action="" method="post" enctype="multipart/form-data"><!-- form Begin -->
    ...
    <div class="form-group"><!-- form-group Begin -->
        ...
        <img class="img-responsive" src="customer_images/<?php echo $customer_image; ?>" style="width:200px; height:250px;" alt="Costumer Image">
...
if(isset($_POST['update'])){
    ...
    if($run_customer){
        ...
        echo "<script>alert('Your Profile Has Been Edited. Please Relogin')</script>";
